...
import com.farwolf.weex.component.WXHtmlView;
...
import com.farwolf.weex.module.WXFWebUtilModule;
...
//                debugManager.disConnect();
    ...
    public void init(Application application, String name, String groupname,String basedir)
    {
        ...
        try {
            ...
            WXSDKEngine.registerModule("webutil", WXFWebUtilModule.class);
...
//            registerComponent("viewpager",WXViewPager.class);
            ...
            registerComponent("vhtml",WXHtmlView.class);
        } catch (WXException e) {
            e.printStackTrace();
        }
    }
